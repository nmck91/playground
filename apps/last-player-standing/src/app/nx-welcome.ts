      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build last-player-standing
<span># Test</span>
nx test last-player-standing
<span># Lint</span>
nx lint last-player-standing
<span># Run them together!</span>
nx run-many -p last-player-standing -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project last-player-standing</pre>
          </details>
