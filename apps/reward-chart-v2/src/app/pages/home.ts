      ...
      <div class="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-12 max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div class="flex gap-3 sm:gap-4">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-slate-600 text-xs sm:text-sm">Kids earn stars for good behavior and completing tasks</p>
                </div>
              </div>
              <div class="flex gap-3 sm:gap-4">
                <span class="text-2xl sm:text-3xl flex-shrink-0">&#x1F468;&#x200D;&#x1F469;&#x200D;&#x1F467;</span>
              ...
              <div class="flex gap-3 sm:gap-4">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-slate-600 text-xs sm:text-sm">All devices stay in sync with Supabase cloud storage</p>
                </div>
              </div>
              <div class="flex gap-3 sm:gap-4">
                <span class="text-2xl sm:text-3xl flex-shrink-0">&#x1F4CA;</span>
          ...
          <div class="mb-8 sm:mb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <div *ngFor="let member of kidsMembers" class="member-card">
                <div class="bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-shadow p-4 sm:p-5 lg:p-6 border-l-4 cursor-pointer" [ngClass]="getMemberBorderClass(member.color)" (click)="goToChildTracking(member.id)">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <div *ngFor="let member of parentMembers" class="member-card">
                <div class="bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-shadow p-4 sm:p-5 lg:p-6 border-l-4" [ngClass]="getMemberBorderClass(member.color)">
                  <div class="flex items-start justify-between gap-3 mb-4">
                    <div class="min-w-0 flex-1">
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 border-t-4 border-brand-secondary">
          ...
          <div class="space-y-2 text-xs sm:text-sm text-slate-600">
            <p>&#x2705; <strong>Local + Cloud Storage</strong> - Data is saved locally and synced to Supabase</p>
            <p>&#x1F680; <strong>Multi-device Sync</strong> - Access your data from any device</p>
