...
**Shared Workspace Preset**: All applications use a centralized Tailwind configuration for consistent design tokens.

#### tailwind-workspace-preset.js (Workspace Root)

The shared preset contains the complete design system used across all applications:
  ...
  theme: {
    extend: {
      colors: {
        ...
        teal: { 300: '#32B8C6', 400: '#2DA6B2', 500: '#21808D', 600: '#1D7480', 700: '#1A6873', 800: '#2996A1' },
        slate: { 500: '#626C71', 900: '#13343B' },
        brown: { 600: '#5E5240' },
        charcoal: { 700: '#1F2121', 800: '#262828' },
        'child-1': '#87CEEB',  // Domain-specific colors
        'child-2': '#90EE90',
        'child-3': '#DDA0DD',
        'parent': '#FFE55C',
      },
      ...
      fontSize: { xs: '11px', sm: '12px', base: '14px', lg: '16px', xl: '18px', '2xl': '20px', '3xl': '24px', '4xl': '30px' },
      spacing: { 4: '4px', 8: '8px', 12: '12px', 16: '16px', 24: '24px', 32: '32px' },
      borderRadius: { sm: '6px', base: '8px', md: '10px', lg: '12px' },
      boxShadow: {
...
#### App Configuration (Both Apps)

Each application extends the shared preset:

```javascript
// apps/family-calendar/tailwind.config.js
// apps/reward-chart/tailwind.config.js
...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // All shared design tokens come from the preset
    },
  },
...
**Benefits of Shared Preset**:
- ✅ Single source of truth for design tokens
- ✅ Consistent theming across all applications
- ✅ Easy to add new apps with same design system
- ✅ App-specific customizations still possible
